...
<template>
  <div class="flex h-full flex-col gap-6 p-6">
    <LmtPageHeader
      :eyebrow="t('charuco.eyebrow')"
      :title="t('charuco.title')"
      :description="t('charuco.description')"
    >
      <template #actions>
        <LmtStatusBadge tone="info" label="M2" icon="circle-dot" size="md" />
      </template>
    </LmtPageHeader>
