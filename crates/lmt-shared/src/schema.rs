//! 把 lmt-shared 公开类型的 JSON Schema 一次性 dump 出来,供 CLI 的
...
//! ```
//!
//! `incomplete` 列表里的类型嵌入了 lmt-core domain 类型;为保持 core
...
pub fn dump_all() -> Value {
    ...
    json!({
        ...
        "incomplete": ["ReconstructionResult", "ReconstructionReport"],
        "incomplete_reason":
            "these types embed lmt-core domain types (ReconstructedSurface, \
